...
var Player = (function () {
    ...
    // -------------------------------------------------------------------------
    Player.prototype.setup = function (x, y) {
    ...
    Player.prototype.setPos = function (x, y, vx, vy) {
    ...
    Player.prototype.update = function () {
        ...
        this.sprite.position.setTo(this.game.math.bezierInterpolation(this.points.x, t), this.game.math.bezierInterpolation(this.points.y, t));
    ...
    Player.prototype.render = function () {
        for (var t = 0; t < 1; t += 0.01) {
            this.game.debug.pixel(this.game.math.linear(this.x2, this.x, t), this.game.math.linear(this.y2, this.y, t), 'rgba(0,255,255,1)');
            this.game.debug.pixel(this.game.math.bezierInterpolation(this.points.x, t), this.game.math.bezierInterpolation(this.points.y, t), 'rgba(255,255,0,1)');
        }
        for (var t = 0; t < 1; t += 0.01) {
            this.game.debug.pixel(this.game.math.linear(this.points.x[0], this.points.x[1], t), this.game.math.linear(this.points.y[0], this.points.y[1], t), 'rgba(0,0,255,' + t + ')');
            this.game.debug.pixel(this.game.math.linear(this.points.x[3], this.points.x[2], t), this.game.math.linear(this.points.y[3], this.points.y[2], t), 'rgba(0,0,255,' + t + ')');
        }
    };
    // -------------------------------------------------------------------------
